...
public class RepoMain {
	...
	public static void main(String[] args) throws Exception {
		...
		if (env.equalsIgnoreCase("REMOTE")) {
			mvnFormatString = "mvn archetype:generate -DarchetypeGroupId=com.company.bp.suport  -DarchetypeArtifactId=bp-service-archetype -DarchetypeVersion=0.0.7-SNAPSHOT -DgroupId=%s -DartifactId=%s -Dversion=%s -Ddescription=%s -DinteractiveMode=false ";
